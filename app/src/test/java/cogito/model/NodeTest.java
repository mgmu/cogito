...
class NodeTest {
    ...
    void equalsWithIntegerReturnsFalse() {
        Node sut = new Node("test");
        assertFalse(sut.equals(1), "a Node should not be equal to an Integer");
    }
    ...
    void equalsIsSymmetric() {
        Node sut1 = new Node("test");
        Node sut2 = new Node("test");
    ...
    @Test
    void equalsReturnsFalseWithNodeThatHasADifferentEntry() {
        Node sut1 = new Node("test");
        Node sut2 = new Node("test");
        sut1.addEntry("entry 1");
        sut2.addEntry("entry 1");
        sut1.addEntry("entry 2");
        sut2.addEntry("entri 2");
        sut1.addEntry("entry 3");
        sut2.addEntry("entry 3");
        assertFalse(sut1.equals(sut2));
    }

    @Test
    void twoNodesWithSameTitleAndSameEntriesAreEqual() { 
        Node sut1 = new Node("test");
        Node sut2 = new Node("test");
        sut1.addEntry("entry 1");
        sut2.addEntry("entry 1");
        sut1.addEntry("entry 2");
        sut2.addEntry("entry 2");
        sut1.addEntry("entry 3");
        sut2.addEntry("entry 3");
        assertTrue(sut1.equals(sut2));
    }
